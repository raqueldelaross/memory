...
(function() {
  ...
  function finalize() {
    ...
    if (scoreIncrementer === 8) {
      endGame.querySelector('h1').innerText = 'Ganaste :)';
    }
    else {
      endGame.querySelector('h1').innerText = 'Perdiste :(';
    }
    endGame.querySelector('.final-score').innerText = 'puntuación: ' + scoreIncrementer + ' ✔';
    endGame.querySelector('.time').innerText = 'tiempo restante: ' + timeLoss + ' segundos.';
  }
